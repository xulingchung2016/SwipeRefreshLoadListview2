...
//		setSelection(mTotalItemCount - 1); // scroll to bottom
    ...
    private int record;
    private final int AUTO_REFRESH = 100;
	...
	public void autoRefresh(){
		/*updateHeaderHeight(400 / OFFSET_RADIO);
		invokeOnScrolling();
		mPullRefreshing = true;
		mHeaderView.setState(XListViewHeader.STATE_REFRESHING);
		if (mListViewListener != null) {
	        ...
	        if (getFirstVisiblePosition() == 0) {
	            ...
	            if (mEnablePullRefresh && mPullRefreshing != true) {
	                ...
	                if (mHeaderViewHeight == 0) {
	                    ...
	                    int height = mHeaderViewContent.getMeasuredHeight();
	                    Log.i("test>>>>>>>>>>>>>>>", "高度："+height);
	                    mScroller.startScroll(0, 0, 0, height, SCROLL_DURATION);//mHeaderViewContent.getMeasuredHeight()
	                    invalidate();
	                } else {
